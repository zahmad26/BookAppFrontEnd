      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={{ flexDirection: "row", marginTop: 20 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ textAlign: "left", color: "white", fontSize: 15 }}>
                {" "}
                4.3{" "}
              </Text>
            </View>
            ...
            <View style={{ flex: 1 }}>
              <Text
                style={{ textAlign: "right", color: "white", fontSize: 15 }}
              >
                2000 .
              </Text>
            </View>
          ...
          >
            <View style={{ flex: 1 }}>
              <Text
                style={{ textAlign: "left", color: "#A397AA", fontSize: 15 }}
              >
                {" "}
                Rating{" "}
              </Text>
            ...
            <View style={{ flex: 1 }}>
              <Text
                style={{ textAlign: "center", color: "#A397AA", fontSize: 15 }}
              >
                Reviews
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text
                style={{ textAlign: "right", color: "#A397AA", fontSize: 15 }}
              >
                Pages .
              </Text>
            </View>
